...
export default function Item({ title = "", mainCategoryLink = "", categoryList = [], categoryLinkList = [], categoryImage = "" }: Props) {
    ...
    return (
        <>
            <div className={`${styles["item-menu-container"]} ${isOpened ? styles["item-menu-container-opened"] : ""}`}
                style={{
            ...
            <div className={`${styles["item-container"]} ${isOpened ? styles["item-container-opened"] : ""}`}
                style={{
